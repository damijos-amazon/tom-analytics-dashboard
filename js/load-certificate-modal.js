// Inject Certificate Modal HTML directly (no fetch needed for file:// protocol)
(function() {
    if (document.getElementById('certificateModal')) {
        console.log('Certificate modal already exists');
        return;
    }
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 15px;">
                        <label style="display: flex; align-items: center; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 10px; cursor: pointer; border: 2px solid transparent; transition: all 0.3s;" onmouseover="this.style.borderColor='#FFD700'" onmouseout="this.style.borderColor='transparent'">
                            ...
                            <span style="font-size: 16px; font-weight: bold;">🚗 Driver of the Month</span>
                        </label>
                        <label style="display: flex; align-items: center; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 10px; cursor: pointer; border: 2px solid transparent; transition: all 0.3s;" onmouseover="this.style.borderColor='#FFD700'" onmouseout="this.style.borderColor='transparent'">
                        ...
                        <label style="display: flex; align-items: center; padding: 15px; background: rgba(255,255,255,0.1); border-radius: 10px; cursor: pointer; border: 2px solid transparent; transition: all 0.3s;" onmouseover="this.style.borderColor='#FFD700'" onmouseout="this.style.borderColor='transparent'">
                            <input type="radio" name="awardType" value="driverstar" style="width: 20px; height: 20px; margin-right: 15px; cursor: pointer;">
...
`;
    ...
    console.log('✅ Certificate modal injected successfully');
})();
